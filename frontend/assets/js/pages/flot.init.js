! function(d) {
    ...
    o.prototype.createPlotGraph = function(o, t, a, e, r, i, l) {
    ...
    }, o.prototype.createPlotDotGraph = function(o, t, a, e, r, i, l) {
        d.plot(d(o), [{
            data: t,
            label: e[0],
            color: r[0]
    ...
    }, o.prototype.createPieGraph = function(o, t, a, e) {
        var r = [{
                label: t[0],
                data: a[0]
            }, {
        ...
        for (var t = [], a = 0; a < this.$realData.length; ++a) t.push([a, this.$realData[a]]);
        return t
    }, o.prototype.createRealTimeGraph = function(o, t, a) {
        return d.plot(o, [t], {
            colors: a,
            series: {
                grow: {
    ...
    }, o.prototype.createDonutGraph = function(o, t, a, e) {
        var r = [{
                label: t[0],
                data: a[0]
            }, {
        ...
        d.plot(d(o), e, r)
    }, o.prototype.createLineGraph = function(o, t, a, e) {
        var r = {
            series: {
                lines: {
                    show: !0
        ...
        this.createPlotGraph("#website-stats", [
            ...
            [11, 19],
            [12, 11]
        ], ["Bitcoin", "Ethereum", "Litecoin"], ["#4fc6e1", "#6658dd"], "#f5f5f5", "#fff");
        this.createPlotDotGraph("#website-stats1", [
            ...
            [11, 14],
            [12, 5]
        ], ["Bitcoin", "Ethereum"], ["#6658dd", "#f1556c"], "#f5f5f5", "#fff");
        this.createPieGraph("#pie-chart #pie-chart-container", ["Bitcoin", "Ethereum", "Litecoin", "Bitcoin Cash", "Cardano"], [48, 30, 15, 32, 26], ["#4a81d4", "#f672a7", "#f7b84b", "#4fc6e1", "#1abc9c"]);
        var t = this.createRealTimeGraph("#flotRealTime", this.randomData(), ["#4a81d4"]);
        t.draw();
        var a = this;
        ! function o() {
            t.setData([a.randomData()]), t.draw(), setTimeout(o, (d("html").hasClass("mobile-device"), 500))
        }();
        this.createDonutGraph("#donut-chart #donut-chart-container", ["Bitcoin", "Ethereum", "Litecoin", "Bitcoin Cash", "Cardano"], [48, 30, 15, 32, 26], ["#4a81d4", "#f672a7", "#f7b84b", "#4fc6e1", "#1abc9c"]);
        var o = [
            [
                [0, 201],
                [1, 520],
