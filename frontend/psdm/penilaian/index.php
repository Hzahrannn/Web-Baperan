                                  ...
                                  <tr border="0">
                                    ...
                                    <td width="40%">
                                        <select class="form-control" name="dinas">
                                            ...
                                            <option value="inti">BPH INTI</option>
                                            <option value="psdm">Dinas PSDM</option>  
                                            <option value="akademik">Dinas Akademik</option>
                                            <option value="bistra">Dinas Bistra</option>
                                            <option value="kestari">Dinas Kestari</option>
                                            <option value="kastrad">Dinas Kastrad</option> 
                                            <option value="humas">Divisi Humas</option>
                                            <option value="mulmed">Divisi Multimedia</option> 
                                            <option value="olahraga">Divisi Olahraga</option>
                                            <option value="seni">Divisi Seni</option>
                                        </select>
                                      </td>
                                    </tr>
                                    <tr>
