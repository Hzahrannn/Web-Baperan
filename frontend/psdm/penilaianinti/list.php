...
<head>
    ...
    <body class="" >
        ...
        if ($_POST['dinas'] == 'PSDMINTI' &&  $data['nim'] == '09031281722032' || $data['nim'] == '09031181722002')  {
        } 
        ...
        echo "<script>
                    Swal.fire('Akses Gagal !', 'Maaf anda tidak memiliki akses untuk membuka ini.', 'error').then(function(){
