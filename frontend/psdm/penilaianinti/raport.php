...
if ($_SESSION['nim'] != $id) {
	echo "<script>alert('Hayo ngapain, dilarang melihat Raport orang lain.');location='../../index.php';</script>";
}
                    ...
                    <div class="col-xl-12" >
						...
						<table class="table m-0">
							<tr>
								...
								<td><center><b>Penilaian 9 Bulan</b></center></td>
							</tr>
							<tr>
								<td>Akhlak dan Perilaku</td>
								<td><center><?php echo $cek['n1b3']; ?></center></td>
								<td><center><?php echo $cek['n1b6']; ?></center></td>
								<td><center><?php echo $cek['n1b9']; ?></center></td>
							</tr>
							<tr>
								<td>Keaktifan di dalam organisasi</td>
								<td><center><?php echo $cek['n2b3']; ?></center></td>
								<td><center><?php echo $cek['n2b6']; ?></center></td>
								<td><center><?php echo $cek['n2b9']; ?></center></td>
							</tr>
							<tr>
								<td>Kedisiplinan</td>
								<td><center><?php echo $cek['n3b3']; ?></center></td>
								<td><center><?php echo $cek['n3b6']; ?></center></td>
								<td><center><?php echo $cek['n3b9']; ?></center></td>

							</tr>
							<tr>
								<td>Kerjasama dalam Tim</td>
								<td><center><?php echo $cek['n4b3']; ?></center></td>
								<td><center><?php echo $cek['n4b6']; ?></center></td>
								<td><center><?php echo $cek['n4b9']; ?></center></td>

							</tr>
							<tr>
								<td>Komunikasi dengan sesama anggota</td>
								<td><center><?php echo $cek['n5b3']; ?></center></td>
								<td><center><?php echo $cek['n5b6']; ?></center></td>
								<td><center><?php echo $cek['n5b9']; ?></center></td>

							</tr>
							<tr>
								<td>Kreatifitas dan Inovasi</td>
								<td><center><?php echo $cek['n6b3']; ?></center></td>
								<td><center><?php echo $cek['n6b6']; ?></center></td>
								<td><center><?php echo $cek['n6b9']; ?></center></td>

							</tr>
							<tr>
								<td>Tanggung Jawab </td>
								<td><center><?php echo $cek['n7b3']; ?></center></td>
								<td><center><?php echo $cek['n7b6']; ?></center></td>
								<td><center><?php echo $cek['n7b9']; ?></center></td>
