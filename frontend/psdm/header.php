                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="../penilaianinti">Penilaian</a>
                                    </li>
                                    <li>
                                        <a href="../raportbph">Raport BPH</a>
                                    </li> 
                                     <li>
                                        <a href="../absensinti">Absensi Proker</a>
                                    </li> 
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="../absensi">Absensi Proker</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="../penilaian/raport.php?core=penilaian&nim=<?php echo $data['nim']; ?>">Hasil Penilaian</a>
                                    </li> 
